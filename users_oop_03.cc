...
// A new subclass based on Student class, again inheriting all members and
// extending it.
class Doktorand : public Student {
  protected:
    string thesis_title;
  public:
...
int main() {
    Doktorand student1;  // instantiate object of type Doktorand and assign to variable student1
    ...
    student1.setTitle("A comparative study of OOP paradigms in different programming languages");
